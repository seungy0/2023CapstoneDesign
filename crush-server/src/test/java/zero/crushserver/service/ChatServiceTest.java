...
class ChatServiceTest {
    ...
    String system_role = "You are a competent fashion stylist. You can look at a given set of clothes and their conditions and recommend suitable combinations in Korean. It must be appropriate for the option."
    + "output must be: { [ cloth1, cloth2, describe Why we recommend it ], [ cloth1, cloth2, describe Why we recommend it ], ... }. Up to 3 combinations.";
